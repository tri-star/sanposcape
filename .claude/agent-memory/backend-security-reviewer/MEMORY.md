...
- [sanposcape backend security conventions](project_sanposcape_conventions.md) — IDOR pattern (404 not 403, user_id-required repos), cursor tokens don't need signing here; authorize before decoding the cursor
