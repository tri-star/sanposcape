...
import { activeWalkRouteOptions } from "@/features/walk/lib/activeWalkRoute";
...
export function useActiveWalk(): UseActiveWalkResult {
  ...
  const route = useQuery<WalkRoute>(activeWalkRouteOptions(activeWalk?.clientWalkId ?? null));
